        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                  ...
                  {{Form::open(array('url'=>'admin/users','method'=>'post','name'=>'create-category','files'=>'true','class'=>'needs-validation','novalidate'))}}
                    <div class="row">
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                {{Form::password('password',array('class'=>'form-control','id'=>'validationCustom04','placeholder'=>'password','required'))}}
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="form-group mb-3">
                                ...
                                {{Form::select('roles',array(''=>'Select Role','1'=>'Admin','2'=>'User'),'',array('class'=>'form-control','id'=>'validationCustom04','required'))}}
